...
public class CollectionsDemo {
	...
	public static void main(String[] args) {
		...
		for(int x = 0; x < intArray.length; x++) {
		  ...
		  List<Integer> integerList = new ArrayList<>(); integerList.add(51);
		  integerList.add(88); integerList.add(55); integerList.add(13);
		  integerList.add(99);
		  
		  System.out.println(integerList.contains(88));
		  System.out.println(integerList.size());
		  System.out.println(integerList.get(0)); System.out.println(integerList);
